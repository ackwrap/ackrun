...
func writeSSHError(c *gin.Context, err error) {
	...
	case "SSH_HOST_KEY_UNKNOWN", "SSH_HOST_KEY_CHANGED", "SSH_HOST_KEY_CHALLENGE_INVALID",
		...
		"SSH_SFTP_EXISTS", "SSH_SFTP_CONFLICT", "SSH_SINGBOX_CONFIG_CONFLICT", "SSH_SINGBOX_NOT_INSTALLED",
		"SSH_MCP_FILE_EXISTS":
	...
	case "SSH_SHARE_TOO_LARGE":
		status = http.StatusRequestEntityTooLarge
	case "SSH_SFTP_BINARY", "SSH_MCP_CHECKSUM_MISMATCH":
		status = http.StatusUnprocessableEntity
	case "SSH_CONNECT_TIMEOUT":
		status = http.StatusGatewayTimeout
	case "SSH_MONITOR_TIMEOUT":
		status = http.StatusGatewayTimeout
	case "SSH_SESSION_LIMIT", "SSH_MONITOR_BUSY", "SSH_SINGBOX_DEPLOY_BUSY":
	...
	case "SSH_HOST_DISABLED", "SSH_NODE_EXPOSURE_DISABLED", "SSH_NODE_EXPOSURE_UNAVAILABLE",
		...
		"SSH_SINGBOX_PREFLIGHT_FAILED", "SSH_SINGBOX_INSTALL_FAILED", "SSH_SINGBOX_DEPLOY_FAILED",
		"SSH_MCP_SFTP_FAILED", "SSH_MCP_SFTP_UNSUPPORTED", "SSH_MCP_SOURCE_FAILED", "SSH_MCP_TRANSFER_FAILED":
	...
	case "SSH_HOST_INVALID", "SSH_CREDENTIAL_INVALID", "SSH_REFERENCE_INVALID", "SSH_SFTP_INVALID_PATH",
		...
		"SSH_SINGBOX_ROOT_REQUIRED", "SSH_SINGBOX_CONFIG_INVALID", "SSH_MCP_INVALID", "SSH_MCP_TRANSFER_INCOMPLETE":
		status = http.StatusBadRequest
	case "SSH_SINGBOX_INSTALL_TIMEOUT", "SSH_SINGBOX_DEPLOY_TIMEOUT", "SSH_MCP_CANCELLED":
		status = http.StatusGatewayTimeout
	}
	c.JSON(status, model.ErrorResponse{Error: apiError})
}
