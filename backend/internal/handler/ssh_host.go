...
func writeSSHError(c *gin.Context, err error) {
	...
	case "SSH_HOST_NOT_FOUND", "SSH_CREDENTIAL_NOT_FOUND", "SSH_NODE_EXPOSURE_NOT_FOUND":
	...
	case "SSH_HOST_DISABLED", "SSH_NODE_EXPOSURE_DISABLED", "SSH_NODE_EXPOSURE_UNAVAILABLE",
		...
		"SSH_SESSION_OPEN_FAILED", "SSH_SESSION_OPEN_TIMEOUT":
		status = http.StatusBadGateway
	case "SSH_HOST_INVALID", "SSH_CREDENTIAL_INVALID", "SSH_REFERENCE_INVALID":
